                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="example-select" name="status">
                                                ...
                                                <option value="online"  <?php if ($user['status'] == 'online'): ?> selected <?php endif ?>>Онлайн</option>
                                                <option value="offline" <?php if ($user['status'] == 'offline'): ?> selected <?php endif ?>>Отошел</option>
                                                <option value="away"    <?php if ($user['status'] == 'away'): ?> selected <?php endif ?>>Не беспокоить</option>
                                            </select>
                                        </div>
                                    </div>
