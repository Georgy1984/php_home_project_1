                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <?php if ($user['image'] == null): ?> 
                                        <img src="/project_1/upload_avatar/nophoto.png"  alt="user-photo" class="img-responsive" width="200">
                                    <?php else: ?>                                    
                                        <img src="/project_1/upload_avatar/<?= $user['image'] ?>"  alt="user-photo" class="img-responsive" width="200">
                                     <?php endif; ?>   
